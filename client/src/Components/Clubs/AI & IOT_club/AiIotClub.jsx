        ...
        <Layout>
          ...
          <section className="bg-gray-100 py-12 px-4">
            <div className="container mx-auto text-center">
              ...
              Through hands-on projects, coding workshops, and expert-led sessions, the club nurtures essential skills in AI model development, sensor integration, automation, and data-driven decision-making—skills that are vital for careers in smart systems, robotics, data science, and embedded engineering.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
                Whether it's designing smart home applications, developing intelligent chatbots, or connecting physical devices to the cloud, the AI and IoT Club offers a collaborative environment to experiment, innovate, and lead in the era of intelligent connectivity. It’s where intelligence meets innovation.
              </p>
            </div>
          </section>
          ...
          <section className="bg-blue-50 py-8 px-4">
            <div className="container mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-bold text-blue-500 mb-4">
                Incharge of Club: Er. Ankita Maheshwari
              </h2>
            </div>
          </section>
          ...
          <section className="bg-white py-12 px-4">
            <div className="container mx-auto text-center">
              ...
              <p className="text-gray-700 mb-6">
                Ready to level up your AI & IoT journey? Join our community!
              </p>
              <button
