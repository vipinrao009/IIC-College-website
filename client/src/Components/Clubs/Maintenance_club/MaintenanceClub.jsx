        ...
        <Layout>
          ...
          >
            <div className="container mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Welcome to Institute Of Engineering And Technology, Khandari Maintenance Club!
              </h1>
              <p className="text-lg md:text-xl">
              The Maintenance Club is the backbone of campus operations, dedicated to ensuring the smooth functioning and upkeep of college infrastructure and facilities. It brings together a team of responsible and technically skilled students who are passionate about solving real-time issues related to repair, maintenance, and resource optimization.</p>
            </div>
          </section>
          ...
          <section className="bg-gray-100 py-12 px-4">
            <div className="container mx-auto text-center">
              ...
              From managing electrical systems and plumbing solutions to maintaining laboratories and classrooms, the club takes a proactive approach in creating a safe, clean, and efficient environment for everyone. Members gain hands-on experience in facility management, preventive maintenance, and teamwork through regular campus drives and repair tasks.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
              The Maintenance Club cultivates a spirit of accountability, problem-solving, and service — making it an essential pillar in the sustainable growth and day-to-day harmony of the institution.
              </p>
            </div>
          </section>
