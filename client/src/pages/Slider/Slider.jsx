          ...
          <div key={index} className="relative">
            ...
            <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
              <div className="text-center text-white px-6 max-w-2xl animate-fadeIn">
                <h2 className="text-4xl md:text-5xl font-extrabold tracking-wide mb-4 animate-fadeInUp">
                  OUR <span className="text-yellow-400 drop-shadow-md">MISSION</span>
                </h2>
                <p className="text-lg md:text-xl leading-relaxed text-gray-200 animate-fadeIn delay-300">
                  We always provide our best educational services to empower and uplift every student towards excellence.
                </p>
                <div className="mt-6">
                  <button onClick={() => navigate("/about")}  className="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold rounded-full shadow-lg transition duration-300">
                    Learn More
                  </button>
                </div>
              </div>
